...
import math
from PointAttn.utils.model_utils import *

from PointAttn.utils.mm3d_pn2 import furthest_point_sample, gather_points
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        if args.dataset == 'pcn':
            ...
            step1 = 1
            step2 = 4
        elif args.dataset.train._base_.NAME == 'ScaphoidDataset':
            step1 = 4
            step2 = 8
    ...
    def forward(self, x, gt=None, is_training=True):
        ...
        if is_training:
            ...
            return fine, loss1, loss2, total_train_loss
            # ret, sparse_loss, dense_loss, total_loss
        else:
            cd_p, cd_t = calc_cd(fine1, gt)
            cd_p_coarse, cd_t_coarse = calc_cd(coarse, gt)

            return {'out1': coarse, 'out2': fine1, 'cd_t_coarse': cd_t_coarse, 'cd_p_coarse': cd_p_coarse, 'cd_p': cd_p, 'cd_t': cd_t}
            # coarse=sparse, fine=dense
